...
static std::vector<std::string> s_Preset_print_options {
    ...
    "solid_infill_below_area", "only_retract_when_crossing_perimeters", "infill_first", "nozzle_landing_mode", "nozzle_landing_max_distance", "nozzle_landing_offset", "nozzle_landing_anchor_length",
